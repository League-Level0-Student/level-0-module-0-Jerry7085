...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			JOptionPane.showMessageDialog(null, "THE PLAYER ATTACKS THE DRAGON");
				// 3. Ask the player in a pop-up if they want to attack the dragon with a yell
				// or a kick
			String answer = JOptionPane.showInputDialog("How do you attacks the dragon? A yell or kick");
			...
			// 		dragon.
			JOptionPane.showMessageDialog(null, "your health "+ playerhealth+" the dragon's health "+dragonhealth );
	...
	static void dragonLost() {
		...
		JOptionPane.showMessageDialog(null, "you defeated the dragon and get ton of gold");
		System.exit(0);   //This code ends the program
	}
