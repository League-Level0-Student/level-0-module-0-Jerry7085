...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String prompt =  "If you find yourself having to cross a piranha-infested river,\n here's how to do it...";
		JOptionPane.showMessageDialog(null, prompt);
		// Get the player to enter an adjective
		String adjective = JOptionPane.showInputDialog("Enter an adjective.");
		// Get the player to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("Enter a type of liquid that you need.");
		// Get the player to enter a body part
		String bodypart = JOptionPane.showInputDialog("Enter a body part that you need to use.");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog("Enter a verb that you are doing.");
		// Get the player to enter a place
		String place = JOptionPane.showInputDialog("Enter a place you are going");
